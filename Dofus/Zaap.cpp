...
{
	bool ret = false;
	//LogFile("CheckZaap Astrub?");

	COLORREF color1 = GetColor(I_AM_IN_ASTRUB_ZAAP_POS_X_1, I_AM_IN_ASTRUB_ZAAP_POS_Y_1);
	COLORREF color2 = GetColor(I_AM_IN_ASTRUB_ZAAP_POS_X_2, I_AM_IN_ASTRUB_ZAAP_POS_Y_2);
	COLORREF color3 = GetColor(I_AM_IN_ASTRUB_ZAAP_POS_X_3, I_AM_IN_ASTRUB_ZAAP_POS_Y_3);
	...
	{
		LogFile("I am in Astrub Zaap ! ALL OK!!");
		ret = true;
	}
